...
/** 同步 Vxe UI 明暗主题（与 html.dark 保持一致） */
export function toggleVxeUiTheme(darkMode = false) {
  document.documentElement.setAttribute('data-vxe-ui-theme', darkMode ? 'dark' : 'light');
}
